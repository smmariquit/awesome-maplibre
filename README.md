...
- [maplibre-gl-photosphere](https://github.com/clement-igonet/maplibre-gl-photosphere) - A plugin to enter an immersive 360° photosphere anchored at a geographic point, look around (mouse, touch or keyboard), and exit back to the map. Supports Street-View-style navigation between panoramas. [demo](https://clement-igonet.github.io/maplibre-gl-photosphere/)
